...
const hikes = [
  { name: "Lynn Canyon Suspension Bridge & Loop", location: "North Vancouver", distance: "3.2 km loop", difficulty: "Easy", stroller: "No", highlight: "Free suspension bridge (skip Capilano and save $60), 30-Foot Pool swimming hole in summer, stunning old-growth forest. The Twin Falls trail extension is worth the extra 20 minutes.", image: "/images/lynn-canyon.jpg" },
  { name: "Lighthouse Park", location: "West Vancouver", distance: "5 km (various loops)", difficulty: "Easy-Moderate", stroller: "No", highlight: "Point Atkinson lighthouse with jaw-dropping ocean views. Rocky shoreline perfect for tide pool exploration. Massive old-growth Douglas firs. Pack a lunch for the rocks.", image: "/images/lighthouse-park.jpg" },
  { name: "Quarry Rock (Deep Cove)", location: "North Vancouver", distance: "3.8 km return", difficulty: "Easy", stroller: "No", highlight: "The classic Vancouver family hike. Stunning viewpoint overlooking Deep Cove and Indian Arm. Get donuts at Honey Doughnuts after. Go early on weekends — it gets packed.", image: "/images/deep-cove.jpg" },
  { name: "Pacific Spirit Regional Park", location: "UBC/Point Grey", distance: "Various (2-10 km)", difficulty: "Easy", stroller: "Yes (main trails)", highlight: "73 km of trails through coastal forest right in the city. Flat, wide paths perfect for strollers and balance bikes. Wreck Beach access trail for adventurous families.", image: "/images/forest-trail.jpg" },
  { name: "Seawall (Stanley Park)", location: "Stanley Park", distance: "9 km full loop", difficulty: "Easy", stroller: "Yes", highlight: "The most scenic stroller walk in Vancouver. Fully paved, flat, with ocean and mountain views the entire way. Stop at Third Beach or Second Beach pool in summer.", image: "/images/seawall-bike.jpg" },
  { name: "Rice Lake Loop", location: "North Vancouver", distance: "3 km loop", difficulty: "Easy", stroller: "Yes (gravel)", highlight: "Flat loop around a peaceful lake in Lynn Headwaters. Boardwalk sections, bird watching, and fishing platforms. Interpretive signs for kids. Stroller-friendly gravel path.", image: "/images/lake-trail.jpg" },
  { name: "Norvan Falls", location: "North Vancouver", distance: "14 km return", difficulty: "Moderate", stroller: "No", highlight: "For families with older kids (8+) who want a real adventure. Beautiful waterfall at the end, river crossings, and dense forest. Pack lunch and plan for 4-5 hours.", image: "/images/waterfall-hike.jpg" },
  { name: "Burns Bog (Delta Nature Reserve)", location: "Delta", distance: "4 km loop", difficulty: "Easy", stroller: "Yes (boardwalk)", highlight: "Entirely on boardwalk through a unique bog ecosystem. Great for nature-loving kids — carnivorous plants, dragonflies, and birds. Flat and fully accessible.", image: "/images/nature-walk.jpg" },
  { name: "Whytecliff Park", location: "West Vancouver", distance: "1.5 km (explore)", difficulty: "Easy", stroller: "Partial", highlight: "Rocky shore exploration, tide pools, and a small island you can walk to at low tide. Bring water shoes. Perfect half-day outing combined with a picnic.", image: "/images/beach-rocks.jpg" },
  { name: "Jug Island Trail", location: "Belcarra", distance: "5 km return", difficulty: "Moderate", stroller: "No", highlight: "Hidden gem with panoramic views of Indian Arm, Deep Cove, and Jug Island. Less crowded than Quarry Rock. Some root-covered sections — sturdy shoes recommended.", image: "/images/mountain-view.jpg" },
];
